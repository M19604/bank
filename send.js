function sendTransfer() {
    ...
    // LOG TRANSFER
    const scriptURL1 = "https://script.google.com/macros/s/AKfycbyWwtOicigudMa_WXq0z7OpGu16knVtoDzYYCwcMn7pfdIwvrAeEKxlJeVHHd8LU9NU/exec";
    fetch(scriptURL1, { method:"POST", body: new FormData(form) });
    // LOG ADD
    const scriptURL2 = "https://script.google.com/macros/s/AKfycbyyMH_jQ5Z8B098nRoW2c9xc7p6XETMdOf-uXhpV4hgGohti874GtwstZR0Rbx_YYxU/exec";
